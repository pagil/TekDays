	...
	<body>
		...
		<div id="show-tekEvent" class="content scaffold-show" role="main">
			...
			<ol class="property-list tekEvent">
				...
				<g:if test="${tekEventInstance?.responders}">
				<li class="fieldcontain">
					<span id="responders-label" class="property-label"><g:message code="tekEvent.responders.label" default="Responders" /></span>

						<span class="property-value" aria-labelledby="responders-label"><g:fieldValue bean="${tekEventInstance}" field="responders"/></span>
