...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'startDate', 'error')} required">
	...
	<g:datePicker name="startDate" precision="day"  value="${tekEventInstance?.startDate}" years="${2015..2020}" />
...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'endDate', 'error')} required">
	...
	<g:datePicker name="endDate" precision="day"  value="${tekEventInstance?.endDate}" years="${2015..2020}" />
...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'responders', 'error')} ">
	<label for="responders">
		<g:message code="tekEvent.responders.label" default="Responders" />
